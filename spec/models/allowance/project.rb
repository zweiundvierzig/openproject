...
describe Project, 'allowed scope' do
  ...
  it "should be a scope" do
    expect(Allowance.projects(user: user).class).to be(ActiveRecord::Relation)
  end
  ...
  describe "w/ non public projects" do
    describe "w/ the user being admin" do
      ...
      it "should return all projects" do
        expect(Allowance.projects(user: user).all).to match_array([project, project2])
      end
    end
    ...
    describe "w/o the user being admin" do
      ...
      it "should be empty" do
        expect(Allowance.projects(user: user).all).to be_empty
      end
    end
    ...
    describe "w/ the user being member
      ...
      it "should return the project" do
        expect(Allowance.projects(user: user).all).to eq([project])
      end
    end
    ...
    describe "w/ the user being member
      ...
      it "should return the project" do
        expect(Allowance.projects(user: user, permission: permission).all).to eq([project])
      end
    end
    ...
    describe "w/ the user being member
      ...
      it "should be empty" do
        expect(Allowance.projects(user: user, permission: permission).all).to be_empty
      end
    end
    ...
    describe "w/ the user being member
      ...
      it "should be empty" do
        expect(Allowance.projects(user: user, permission: permission.name).all).to be_empty
      end
    end
    ...
    describe "w/ the user being admin
      ...
      it "should include only projects that have the module enabled" do
        expect(Allowance.projects(user: user, permission: permission.name).all).to eq [project2]
      end
    end
    ...
    describe "w/ the user being member
      ...
      it "should return the project" do
        expect(Allowance.projects(user: user, permission: public_permission).all).to eq([project])
      end
    end
    ...
    describe "w/o the user being member
      ...
      it "should be empty" do
        expect(Allowance.projects(user: user, permission: public_permission).all).to be_empty
      end
    end
    ...
    describe "w/ the user being anonymous
      ...
      it "should be empty" do
        expect(Allowance.projects(user: anonymous, permission: permission).all).to be_empty
      end
    end
    ...
    describe "w/ the user being admin
      ...
      it "should return non archived" do
        expect(Allowance.projects(user: user).all).to match_array([project2])
      end
    end
  ...
  describe "w/ public projects" do
    ...
    describe "w/ the user being anonymous
      ...
      it "should return the project" do
        expect(Allowance.projects(user: anonymous, permission: permission).all).to eq [project]
      end
    end
    ...
    describe "w/ the user being anonymous
      ...
      it "should return the project" do
        expect(Allowance.projects(user: anonymous, permission: public_permission).all).to eq [project]
      end
    end
    ...
    describe "w/ the user being anonymous
      ...
      it "should be empty" do
        expect(Allowance.projects(user: anonymous, permission: public_permission).all).to be_empty
      end
    end
    ...
    describe "w/ the user being anonymous
      ...
      it "should be empty" do
        expect(Allowance.projects(user: anonymous, permission: permission.name).all).to be_empty
      end
    end
  end
end
